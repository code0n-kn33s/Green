                  ...
                  <div className="profile-section__client-info">
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        ...
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('main_crypto_balance_btc'))}
                        </p>
                      </div>
                    ...
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('main_crypto_balance_eth'))}
                        </p>
                      </div>
                    ...
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('main_crypto_balance_usdt'))}
                        </p>
                      </div>
              ...
              <div className="profile-section__content-top-side">
                ...
                <div className="profile-section__input">
                  <copy-past className="form-container rel">
                    ...
                    <input className="copy-email" type="text" name="register-link" id="register-link" value={10000 + Number(localStorage.getItem('id'))} readOnly ref={inputRef} />
                  </copy-past>
                </div>
                  ...
                  <div className="profile-section__client-info">
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_crypto_balance_btc'))}
                        </p>
                      </div>
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Профит")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_profit_btc'))}
                        </p>
                      </div>
                    </div>
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_crypto_balance_eth'))}
                        </p>
                      </div>
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Профит")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_profit_eth'))}
                        </p>
                      </div>
                    </div>
                    <div className="profile-section__client-btc-info-wrap">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_crypto_balance_usdt'))}
                        </p>
                      </div>
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Профит")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('arbitech_profit_usdt'))}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="profile-section__client-info">
                    ...
                    <div className="profile-section__client-btc-info-wrap new">
                      ...
                      <div className="profile-section__client-btc-info">
                        <p className="profile-section__client-btc-info-title">{t("Баланс")}:</p>
                        <p className="profile-section__client-btc-info-balance h3">
                          {trunc(localStorage.getItem('options_crypto_balance_usdt'))}
                        </p>
                      </div>
