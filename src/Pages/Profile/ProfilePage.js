              ...
              <div className="profile-section__content-top-side">
                ...
                <div className="profile-section__input">
                  <copy-past className="form-container rel">
                    <label className="copy-email-label" aria-roledescription="button" for="register-link">
                    ...
                    <input className="copy-email" type="text" name="register-link" id="register-link" value="http://dashboard.arbitech7.coM" readOnly />
                  </copy-past>
                </div>
